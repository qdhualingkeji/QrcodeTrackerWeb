...
public class BcpInVerifyResult {
    ...
    private String bz="";
    private Integer bzStatus=0;
    private Integer fzrID=0;
    private String fzr="";
    private Integer fzrStatus=0;
    private Integer zjyID=0;
    private String zjy="";
    private Integer zjyStatus=0;
    private Integer zjldID=0;
    private String zjld="";
    private Integer zjldStatus=0;
    private Integer flfzrID=0;
    private String jhFzr="";
    private Integer flfzrStatus=0;
    private Integer kgID=0;
    private String kg="";
    private Integer kgStatus=0;
    private Integer llfzrID=0;
    private String shFzr="";
    private Integer llfzrStatus=0;
